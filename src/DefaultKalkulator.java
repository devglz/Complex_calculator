...
public class DefaukltKalkulator {

    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);

        System.out.print("Podaj 1 liczbę zespoloną (część rzeczywistą): ");
        double re1 = input.nextDouble();
        System.out.print("Podaj 1 liczbę zespoloną (część urojoną): ");
        double im1 = input.nextDouble();
        Complex z1 = new Complex(re1, im1);

        System.out.print("Podaj 2 liczbę zespoloną (część rzeczywistą): ");
        double re2 = input.nextDouble();
        System.out.print("Podaj 2 liczbę zespoloną (część urojoną): ");
